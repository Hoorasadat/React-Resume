          ...
          <div className="col-md-12">
            <ul className="timeline-1">
              ...
              <li className="event next" data-date="May 2020 – Aug 2020" type="Part Time">
                <h5 className="mb-3">Full-Stack Developer</h5>
                <h6 className="mb-3"><a className="text-decoration-none" rel="noopener noreferrer" target="_blank" href="https://www.footprintsforlearningpreschool.com//">Child Friendly Care (Footprints for Learning Preschool Ltd.)</a></h6>
                <p>
              ...
              <li className="event next" data-date="Jul 2019 – April 2020" type="Full Time">
                <h5 className="mb-3">Full-Stack Developer</h5>
                <h6 className="mb-3"><a className="text-decoration-none" rel="noopener noreferrer" target="_blank" href="https://payload.com/">Payload Technologies Inc.</a></h6>
                <ul>
                  <li>
