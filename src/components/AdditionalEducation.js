          ...
          <div className="col-md-12">
            <ul className="timeline-1">
              <li className="event" data-date="Sep 2005 - May 2007" type="Certificate">
                ...
                <h6 className="mb-3"><a className="text-decoration-none" rel="noopener noreferrer" target="_blank" href="https://www.ustmb.ac.ir/En">Mazandaran University of Science and Technology</a></h6>
